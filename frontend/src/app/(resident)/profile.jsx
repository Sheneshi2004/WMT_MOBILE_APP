      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        {editing ? (
          <Animated.View entering={FadeInDown} style={styles.formSection}>
            ...
            <TextInput label="Full Name" value={formData.name} onChangeText={(t) => setFormData({ ...formData, name: t })} mode="outlined" style={styles.input} theme={{ colors: { primary: COLORS.primary, outline: COLORS.border } }} textColor={COLORS.text} />
            <TextInput label="Phone Number" value={formData.phone} onChangeText={(t) => setFormData({ ...formData, phone: t })} mode="outlined" style={styles.input} keyboardType="phone-pad" theme={{ colors: { primary: COLORS.primary, outline: COLORS.border } }} textColor={COLORS.text} />
            <TextInput label="NIC Number" value={formData.nic} onChangeText={(t) => setFormData({ ...formData, nic: t })} mode="outlined" style={styles.input} theme={{ colors: { primary: COLORS.primary, outline: COLORS.border } }} textColor={COLORS.text} />

            <Text style={styles.subHeader}>ACADEMIC & RESIDENCY</Text>
            <TextInput label="Course of Study" value={formData.course} onChangeText={(t) => setFormData({ ...formData, course: t })} mode="outlined" style={styles.input} theme={{ colors: { primary: COLORS.primary, outline: COLORS.border } }} textColor={COLORS.text} />
            <TextInput label="Year (1-5)" value={formData.year} onChangeText={(t) => setFormData({ ...formData, year: t })} mode="outlined" style={styles.input} keyboardType="numeric" theme={{ colors: { primary: COLORS.primary, outline: COLORS.border } }} textColor={COLORS.text} />
            <TextInput label="Permanent Address" value={formData.permanentAddress} onChangeText={(t) => setFormData({ ...formData, permanentAddress: t })} mode="outlined" style={[styles.input, { height: 100 }]} multiline theme={{ colors: { primary: COLORS.primary, outline: COLORS.border } }} textColor={COLORS.text} />

            <Text style={styles.subHeader}>EMERGENCY CONTACT</Text>
            <TextInput label="Guardian Name" value={formData.guardianName} onChangeText={(t) => setFormData({ ...formData, guardianName: t })} mode="outlined" style={styles.input} theme={{ colors: { primary: COLORS.primary, outline: COLORS.border } }} textColor={COLORS.text} />
            <TextInput label="Guardian Phone" value={formData.guardianPhone} onChangeText={(t) => setFormData({ ...formData, guardianPhone: t })} mode="outlined" style={styles.input} keyboardType="phone-pad" theme={{ colors: { primary: COLORS.primary, outline: COLORS.border } }} textColor={COLORS.text} />
          ...
          <View style={styles.infoSection}>
            <Animated.View entering={FadeInDown.delay(200)}>
              <Card style={styles.infoCard}>
                ...
                <View style={styles.infoRow}><Text style={styles.infoLabel}>Course</Text><Text style={styles.infoValue}>{resident?.course || 'N/A'}</Text></View>
                <View style={styles.infoRow}><Text style={styles.infoLabel}>Level</Text><Text style={styles.infoValue}>Year {resident?.year || '1'}</Text></View>
              </Card>
            </Animated.View>
            ...
            <Animated.View entering={FadeInDown.delay(400)}>
              <Card style={styles.infoCard}>
                ...
                {resident?.roomId ? (
                  <>
                    <View style={styles.infoRow}><Text style={styles.infoLabel}>Room ID</Text><Text style={[styles.infoValue, { color: COLORS.primary }]}>{resident.roomId.roomNumber}</Text></View>
                    <View style={styles.infoRow}><Text style={styles.infoLabel}>Wing/Type</Text><Text style={styles.infoValue}>{resident.roomId.roomType}</Text></View>
                  </>
                ) : (
            ...
            <Animated.View entering={FadeInDown.delay(600)}>
              <Card style={styles.infoCard}>
                ...
                <View style={styles.infoRow}><Text style={styles.infoLabel}>Guardian</Text><Text style={styles.infoValue}>{resident?.guardianName || 'N/A'}</Text></View>
                <View style={styles.infoRow}><Text style={styles.infoLabel}>Contact</Text><Text style={styles.infoValue}>{resident?.guardianPhone || 'N/A'}</Text></View>
              </Card>
            </Animated.View>
...
const styles = StyleSheet.create({
  ...
  backBtn: { padding: 4 },
  editBtn: { paddingHorizontal: 16, paddingVertical: 8, borderRadius: 12, backgroundColor: COLORS.background, borderWidth: 1, borderColor: COLORS.border },
  ...
  avatarInner: { width: 100, height: 100, borderRadius: 50, backgroundColor: COLORS.primary, justifyContent: 'center', alignItems: 'center', borderWidth: 4, borderColor: COLORS.surface },
  avatarText: { fontSize: 40, fontWeight: 'bold', color: COLORS.textDark },
  cameraIcon: { position: 'absolute', bottom: 0, right: 0, backgroundColor: COLORS.white, width: 32, height: 32, borderRadius: 16, justifyContent: 'center', alignItems: 'center', borderWidth: 2, borderColor: COLORS.surface },
  userName: { fontSize: 24, fontWeight: 'bold', color: COLORS.text },
  userEmail: { fontSize: 14, color: COLORS.textLight, marginTop: 4 },
  badge: { backgroundColor: COLORS.surface, paddingHorizontal: 12, paddingVertical: 4, borderRadius: 20, marginTop: 15, borderWidth: 1, borderColor: COLORS.border },
